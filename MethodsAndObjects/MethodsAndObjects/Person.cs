...
namespace MethodsAndObjects
{
    public class Person
    {
        public string FirstName { get; set; } // Create a class called Person and give it two properties, each of data type string. One called FirstName, the other LastName.
